...
class OptimizedTDistributionScaleEstimator
    : public TDistributionScaleEstimator {
public:
...
class ApproximateTDistributionScaleEstimator
    : public TDistributionScaleEstimator {
public:
...
/**
 * Interface for influence functions. An influence function is the first
 *derivative of a symmetric robust function p(sqrt(x)).
